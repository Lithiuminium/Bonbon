...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form action="admin_connect.php">
      <button class="btn btn-outline-dark me-3" type="submit">Admin</button>
      </form>
...
<form action="verif.php" method="POST" class="w-25 mt-3 ms-3" enctype="multipart/form-data">
    <input class="form-control mb-2" type="text" placeholder="Identifiant" aria-label="Default input " name ="admin">
    <input class="form-control" type="password" placeholder="Mot de passe" aria-label="Default input" name ="login">

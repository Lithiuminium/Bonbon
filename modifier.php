...
<div class="container-fluid">
  <div class="col-6">
    <form action="recupmodif.php" method="POST" enctype="multipart/form-data">
    <input class="form-control mb-2" type="text" value="<?php echo $produit->$nom ?>" aria-label="Default input " name ="nom">
    <input class="form-control" type="text" value="<?php echo $produit->$prix?>" aria-label="Default input" name ="prix">

    <label for="formFile" class="form-label">Choisir un fichier</label>
    <input class="form-control" type="file" id="formFile" value="<?php echo $produit->$fichier?>" name="fichier">
    <input type="submit" class="btn btn-danger mt-3" value="Envoyer">
    </div>
</div>
  </form>
